...
**TypeScript Support:** Create Lightning Web Components using TypeScript with full IntelliSense and type checking. Configure `defaultLwcLanguage` in your `sfdx-project.json` to set your preferred language. See the [TypeScript LWC Support Guide](https://github.com/forcedotcom/salesforcedx-vscode/blob/HEAD/../../docs/TYPESCRIPT_LWC_SUPPORT.md) for details.
