class Utility {
    ...
    tryGetAbsoluteUrl(url) {
        ...
        if ((url === null || url === void 0 ? void 0 : url.startsWith('//')) && typeof window === 'object') {
            return ((_a = window.location.protocol) !== null && _a !== void 0 ? _a : '') + url;
        }
        else if ((url === null || url === void 0 ? void 0 : url.startsWith('/')) && typeof window === 'object') {
            return ((_b = window.location.origin) !== null && _b !== void 0 ? _b : '') + url;
        }
        return url;
    }
}
