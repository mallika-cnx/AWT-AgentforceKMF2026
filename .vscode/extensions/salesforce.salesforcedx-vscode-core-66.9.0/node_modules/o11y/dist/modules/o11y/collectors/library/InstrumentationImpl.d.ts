...
import { Activity, ActivityApiOptions, ActivityDetail, ApiOptions, BucketMetric, DomEventApiOptions, Instrumentation, InstrumentationContext, Metric, MetricsReporter, Schema, SchematizedPayload } from '../interfaces';
...
export declare class InstrumentationImpl implements Instrumentation, MetricsReporter {
    ...
    get internalInstrumentationContext(): InstrumentationContext;
