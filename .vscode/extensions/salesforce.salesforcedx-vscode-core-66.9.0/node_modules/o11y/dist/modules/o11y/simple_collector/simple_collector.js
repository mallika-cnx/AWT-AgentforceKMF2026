...
class SimpleCollector {
    constructor(options) {
        ...
        if (options) {
            ...
            if (utility.requireArgumentIfDefined(options.estimatedByteSizeChangeCallback, 'options.estimatedByteSizeChangeCallback', 'function')) {
                this._estimatedByteSizeChangeCallback = options.estimatedByteSizeChangeCallback;
            }
    ...
    _triggerEstimatedByteSizeChange(newSize) {
        var _a;
        return (_a = this._estimatedByteSizeChangeCallback) === null || _a === void 0 ? void 0 : _a.call(this, newSize);
    }
    collect(schema, data, logMeta) {
        ...
        try {
            ...
            this._triggerEstimatedByteSizeChange(this.estimatedByteSize);
        }
        finally {
            this._isCollecting = false;
        }
