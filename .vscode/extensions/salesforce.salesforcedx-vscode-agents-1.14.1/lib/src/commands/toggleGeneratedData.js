...
exports.toggleGeneratedDataOn = toggleGeneratedDataOn;
exports.toggleGeneratedDataOff = toggleGeneratedDataOff;
/*
 ...
 */
async function updateGeneratedDataSetting(value) {
...
async function toggleGeneratedDataOn() {
    await updateGeneratedDataSetting(true);
}
async function toggleGeneratedDataOff() {
    await updateGeneratedDataSetting(false);
}
//# sourceMappingURL=toggleGeneratedData.js.map