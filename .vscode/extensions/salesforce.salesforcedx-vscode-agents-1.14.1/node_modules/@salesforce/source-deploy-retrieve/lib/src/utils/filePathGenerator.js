...
const filePathsFromMetadataComponent = ({ fullName, type }, packageDir) => {
    ...
    if (type.strategies?.adapter === 'bundle' || type.strategies?.adapter === 'uiBundles') {
        const mappings = new Map([
            ...
            ['UIBundle', [(0, node_path_1.join)(packageDirWithTypeDir, `${fullName}${node_path_1.sep}${fullName}.uibundle${constants_1.META_XML_SUFFIX}`)]],
            ...
            [
                'AiAuthoringBundle',
                [(0, node_path_1.join)(packageDirWithTypeDir, `${fullName}${node_path_1.sep}${fullName}.aiAuthoringBundle${constants_1.META_XML_SUFFIX}`)],
            ],
        ]);
