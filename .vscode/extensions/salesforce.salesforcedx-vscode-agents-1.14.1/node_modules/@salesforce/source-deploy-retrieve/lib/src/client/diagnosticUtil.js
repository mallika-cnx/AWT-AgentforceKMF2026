...
const parseDeployDiagnostic = (component, message) => {
    ...
    switch (typeName) {
        ...
        default:
            ...
            throw new sfError_1.SfError(`Unable to parse deploy diagnostic with string message: ${message} for component ${component.fullName}`);
    }
};
...
const getProblemFromMessage = (message, component) => {
    ...
    if (!problem) {
        throw new sfError_1.SfError(`Unable to parse deploy diagnostic with empty problem: ${JSON.stringify(message)} for component ${component.fullName}`);
    }
    return problem;
};
