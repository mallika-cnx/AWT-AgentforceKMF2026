...
exports.posixifyPaths = exports.stringToRegex = exports.envFilter = exports.matchesFile = exports.getReplacements = exports.getContentsOfReplacementFile = exports.getReplacementMarkingStream = exports.replacementIterations = exports.ReplacementStream = exports.getReplacementStreamForReadable = void 0;
/*
...
class ReplacementStream extends node_stream_1.Transform {
    replacements;
    foundReplacements = new Set();
    allReplacements;
    lifecycleInstance = core_1.Lifecycle.getInstance();
    ...
    async _transform(chunk, encoding, callback) {
        let error;
        const { output, found } = await (0, exports.replacementIterations)(chunk.toString(), this.replacements);
    ...
    async _flush(callback) {
        ...
        for (const replacement of this.allReplacements) {
            ...
            if (replacement.singleFile && !this.foundReplacements.has(key)) {
                ...
                await this.lifecycleInstance.emitWarning(`Your sfdx-project.json specifies that ${key} should be replaced in ${replacement.matchedFilename}, but it was not found.`);
            }
        }
        callback();
    }
}
exports.ReplacementStream = ReplacementStream;
/**
