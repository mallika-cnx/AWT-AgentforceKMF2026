...
exports.DEFAULT_CODE_BUILDER_REDIRECT_URI = 'https://api.code-builder.platform.salesforce.com/api/auth/salesforce/callback';
/**
...
class WebOAuthServer extends kit_1.AsyncCreatable {
    ...
    static DEFAULT_AUTH_TIMEOUT = 120_000; // 2 minutes
    authUrl;
    logger;
    webServer;
    oauth2;
    ...
    static getAuthTimeout() {
        ...
        const authTimeout = (0, kit_1.toNumber)(env.getNumber('SF_WEB_OAUTH_SERVER_TIMEOUT', WebOAuthServer.DEFAULT_AUTH_TIMEOUT));
    ...
    async init() {
        ...
        if (env.getBoolean('CODE_BUILDER')) {
            if (this.oauthConfig.clientId && this.oauthConfig.clientId !== authInfo_1.CODE_BUILDER_CONNECTED_APP_INFO.clientId) {
                this.logger.warn(messages.getMessage('warn.invalidClientId', [this.oauthConfig.clientId]));
            }
            this.oauthConfig.clientId = authInfo_1.CODE_BUILDER_CONNECTED_APP_INFO.clientId;
            ...
            this.oauthConfig.redirectUri = env.getString('CODE_BUILDER_REDIRECT_URI') ?? exports.DEFAULT_CODE_BUILDER_REDIRECT_URI;
        }
        else {
